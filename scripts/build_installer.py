...
INSTALLER_FILENAMES = {
    "Windows": "DeadlineCloudForMayaSubmitter-windows-x64-installer.exe",
    "Linux": "DeadlineCloudForMayaSubmitter-linux-x64-installer.run",
    "MacOS": "DeadlineCloudForMayaSubmitter-osx-installer.app",
}
