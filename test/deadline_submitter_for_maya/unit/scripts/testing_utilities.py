...
if os.name == "nt":
    ...
    def _format_exit(exit_code):
        return f"exit {exit_code}\n"

    def _format_args_check(args, args_index):
    ...
    def _format_end_args_check(args_index):
...
def _format_output_and_exit(program_output, exit_code):
    result = []
